...
const INCOME_ENTRIES = [
  { id: 1, date: "2026-07-05", category: "client_payment", amount: 150000, concern: "4R Studio", description: "Wedding Photography" },
  { id: 2, date: "2026-07-04", category: "milestone_payment", amount: 200000, concern: "Truphoto Studio", description: "Real estate project milestone 1" },
  { id: 3, date: "2026-07-03", category: "client_payment", amount: 100000, concern: "Tru Multimedia Limited", description: "Video editing project" },
  { id: 4, date: "2026-07-02", category: "other_income", amount: 50000, concern: "Uthsob Mukhor", description: "Miscellaneous" },
];
...
export default function Income() {
  ...
  const filteredEntries = filterConcern
    ? INCOME_ENTRIES.filter((e) => e.concern === filterConcern)
    : INCOME_ENTRIES;

  const totalIncome = filteredEntries.reduce((sum, e) => sum + e.amount, 0);
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          >
            ...
            <p className="text-2xl font-mono font-semibold mt-2" style={{ color: tokens.bone }}>
              {fmtBDT(totalIncome / filteredEntries.length)}
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-3">
            {filteredEntries.map((entry) => (
              ...
              >
                ...
                <p className="text-sm font-mono" style={{ color: tokens.moss }}>
                  +{fmtBDT(entry.amount)}
                </p>
              </div>
            ))}

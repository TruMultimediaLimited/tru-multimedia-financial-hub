            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {filtered.map((c) => (
                  ...
                  >
                    <td className="py-2.5 pr-3 text-gray-900">{c.name}</td>
                    <td className="py-2.5 pr-3 text-gray-500">{c.phone || c.email || '—'}</td>
                    <td className="py-2.5 pr-3 text-right text-gray-700">{formatMoney(c.totalBilled)}</td>
                    <td className="py-2.5 pr-3 text-right text-gray-700">{formatMoney(c.totalPaid)}</td>

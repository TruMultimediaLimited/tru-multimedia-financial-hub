...
export default function Sheet({ open, onClose, title, children }) {
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div
        className="absolute bottom-0 left-0 right-0 max-h-[90vh] overflow-y-auto rounded-t-2xl bg-surface border-t border-gray-200 pb-[env(safe-area-inset-bottom)]
                   md:inset-0 md:m-auto md:h-fit md:max-h-[85vh] md:w-full md:max-w-lg md:rounded-xl md:border"
      >
        <div className="sticky top-0 flex items-center justify-between px-4 py-3.5 bg-surface border-b border-gray-200">

  ...
  return (
    <div className="relative" ref={ref}>
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
        className="w-full flex items-center justify-between bg-surfaceRaised border border-gray-300 rounded-md px-3 py-2 text-sm text-gray-900"
      >
      ...
      {open && (
        <div className="absolute z-20 mt-1 w-full bg-surfaceRaised border border-gray-200 rounded-lg shadow-lg max-h-64 overflow-y-auto">
          {options.map((o) => (
            <button
              type="button"
              key={o.value}
